...
class AppTranslations {
      ...
      if (value is String) {
        ...
        for (var i = 0; i < value.length; i++) {
          ...
          if (item is String) {
            ...
            throw ArgumentError(
                'Unsupported list item type for key: $fullKey[$i]');
          }
        }
      } else {
  ...
  static String getTranslation(String locale, String key) {
    return translationsFor(locale)[key] ?? 'Translation not found';
  }

  static Map<String, String> translationsFor(String locale) {
    return {
      ...?allTranslations['en'],
